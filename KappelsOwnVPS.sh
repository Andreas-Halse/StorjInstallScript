...
for counter in {28967..29910}; do
 iptables -t nat -A PREROUTING -p tcp --dport $counter -j DNAT --to-destination 84.238.7.220:$counter
 iptables -t nat -A PREROUTING -p udp --dport $counter -j DNAT --to-destination 84.238.7.220:$counter
done
